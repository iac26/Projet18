...
/**
 * \brief	set the target of the current robot
...
/**
 * \brief	store in pointers the data for the current robot
...
/**
 * \brief	return 1 if the current robot is blocked
 */
int robot_get_blocked(void);

/**
 * \brief	set the current robot as not blocked
 */
...
/**
 * \brief	return 1 if the current robot has a target
 */
int robot_has_target(void);

/**
 * \brief	sets the current robot as without target
 */
